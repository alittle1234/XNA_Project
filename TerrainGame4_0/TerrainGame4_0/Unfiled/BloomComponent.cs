...
namespace TerrainGame4_0
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            gaussianBlurEffect = Game.Content.Load<Effect>("Effect\\GaussianBlurB");
            ...
            DepthFormat depthF = pp.DepthStencilFormat;

            // Create a texture for reading back the backbuffer contents.
            resolveTarget = new RenderTarget2D(GraphicsDevice, width, height, true,
                format, depthF);
