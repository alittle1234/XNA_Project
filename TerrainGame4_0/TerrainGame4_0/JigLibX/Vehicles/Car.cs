...
namespace JigLibX.Vehicles
{
    ...
    public class Car
    {
        ...
        public void SetupDefaultWheels()
        {
            ...
            Vector3 BRPos = min + new Vector3(0.0f, 0.0f, 0.0f - dist);
            Vector3 FRPos = min + new Vector3(delta.X, 0.0f, 0.0f - dist);
            Vector3 BLPos = min + new Vector3(0.0f, 0.0f, delta.Z + dist);
            Vector3 FLPos = min + new Vector3(delta.X, 0.0f, delta.Z + dist);
