...
namespace TerrainGame4_0
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        EffectParameter slowTimeParameter;
        ...
        {
            Effect effect = content.Load<Effect>("Effect\\ParticleEffect");
            ...
            slowTimeParameter = parameters["SlowTime"];
        ...
        /// </summary>
        public void SetCamera(Matrix view, Matrix projection, bool Paused, bool slowTime)
        {
            effectViewParameter.SetValue(view);
            effectProjectionParameter.SetValue(projection);
            this.Paused = Paused;
            if(slowTime)
                this.slowTimeParameter.SetValue(0.5f);
            else
                this.slowTimeParameter.SetValue(1f);
        }
