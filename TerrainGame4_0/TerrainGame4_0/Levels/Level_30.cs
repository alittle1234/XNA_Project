...
{
    public class Level_30 : LevelCode
    {
        

        public Level_30() : base( )
        { 
        ...
        public override void Load()
        {
            ...
            playerSpawn = new Spawn(new Vector3(131.8f, 10, -132.2f));
            ...
            spawn.Position = new Vector3(121.65f, 10, -159.3f) * terrainScale;
            ...
            spawn.Position = new Vector3(144.95f, 10, -127.1f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(155.15f, 10, -134.85f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(115.05f, 10, -137.1f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(135f, 10, -116.1f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(126.8f, 10, -106.9f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
