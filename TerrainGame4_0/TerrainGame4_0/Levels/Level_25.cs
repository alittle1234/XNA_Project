...
{
    public class Level_25 : LevelCode
    {
        

        public Level_25() : base( )
        { 
        ...
        public override void Load()
        {
            ...
            playerSpawn = new Spawn(new Vector3(130.2f, 10, -130.7f));
            ...
            spawn.Position = new Vector3(117.5f, 10, -145.25f) * terrainScale;
            ...
            spawn.Position = new Vector3(142.05f, 10, -144.2f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(130.1f, 10, -135.15f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(147.5f, 10, -115.55000000000001f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(117f, 10, -115.55000000000001f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(137.65f, 10, -130.7f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(120.55f, 10, -129.65f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(123.4f, 9, -138.5f) * terrainScale;
            ...
            spawn.Position = new Vector3(139.95f, 10, -122.19999999999999f) * terrainScale;
            spawn.Rotation = new Vector3(3.14f / 4, 0, 0);
