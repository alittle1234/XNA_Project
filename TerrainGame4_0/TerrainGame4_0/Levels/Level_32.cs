...
{
    public class Level_32 : LevelCode
    {
        

        public Level_32() : base( )
        { 
        ...
        public override void Load()
        {
            ...
            playerSpawn = new Spawn(new Vector3(130.05f, 10, -135.55f));
            ...
            spawn.Position = new Vector3(124f, 10, -143.55f) * terrainScale;
            ...
            spawn.Position = new Vector3(144.95f, 10, -143.3f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(144.65f, 10, -131.9f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(142.55f, 10, -121.19999999999999f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(134.4f, 10, -115.44999999999999f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(129.35f, 10, -127.1f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(118.25f, 10, -117.69999999999999f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(111.55f, 10, -134.45f) * terrainScale;
            spawn.Rotation = new Vector3(0, 0, 0);
            ...
            spawn.Position = new Vector3(119.9f, 9, -134.8f) * terrainScale;
            spawn.Rotation = new Vector3(1.5f, 0, 0);
            ...
            spawn.Position = new Vector3(136.95f, 11, -139.25f) * terrainScale;
