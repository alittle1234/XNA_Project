...
namespace TerrainGame4_0
{
    ...
    class MenuEntry
    {
        ...
        public Color myColor = Color.LightGray;
                                                      ...
                                                      GameTime gameTime)
        {
            ...
            float pulsate = 1;// (float)Math.Sin(time * 6) + 1;
                                 ...
                                 bool isSelected, GameTime gameTime)
        {
            ...
            Color yelow = new Color(255, 250, 101);
            Color color = isSelected ? yelow : myColor;
            ...
            spriteBatch.DrawString(font, text, position, color, 0,
                                   origin, scale * textScale, SpriteEffects.None, 0);
        }
